...
console.log(
  '"hi".repeat("3")',
  "hi".repeat("3"),
  '// => "hihihi", since "3" is coerced into the number 3'
);
console.log(
  '"hi".repeat("p")',
  "hi".repeat("p"),
  '// => "", since "p" is coerced into a number, and JS designers decided that non-obvious number strings should be 0'
);
console.log(
  '"hi".repeat([3])',
  "hi".repeat([3]),
  '// => "hihihi", since the array [3] is coerced into the number 3'
);
console.log(
  '"hi".repeat([3, 4])',
  "hi".repeat([3, 4]),
  '// => "", since the array [3, 4] is coerced into the number 0'
);
console.log(
  '"hi".repeat(null)',
  "hi".repeat(null),
  '// => "", since the array null is coerced into the number 0'
);
